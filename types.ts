...
const translations: Record<string, any> = {
  en: {
    ...
    aboutPage: {
      missionTitle: "Mission Statement & Values",
      missionText1: "At Janpanah, we operate on a core philosophy: We are therapists for animals first. Our primary mission is to treat injured animals that have no other supporter.",
      missionText2: "We believe in the \"Cycle of Kindness\" (چرخه محبت). Kindness exists in everyone, regardless of background or belief. Our role is to nurture this kindness through education, example, and direct action.",
      missionPoints: [
        "Treatment First: Medical care for the injured is our top priority.",
        "Culture Building: Changing societal views on stray animals.",
        "Sterilization over Elimination: Humane population control."
      ],
      historyTitle: "Our History",
      historyText: "Founded by Monireh Safari, Janpanah began as a small initiative to help injured strays in Tehran. Over the years, it has grown into a comprehensive shelter and treatment center, pioneering the use of technology and community engagement to save lives.",
      transparencyTitle: "Financial Transparency",
      transparencyText: "We believe trust is the foundation of charity. Our financial reports are regularly audited and available for review. We ensure that every donation goes directly towards the medical care, food, and shelter of our animals."
    },
    supportPage: {
      subtitle: "Your kindness keeps our doors open. Every contribution directly saves a life.",
      donation: {
        description: "We rely entirely on public support. Your donation provides:",
        items: [
          "Emergency surgeries for accident victims",
          "Vaccinations and sterilization",
          "Daily food and shelter maintenance"
        ],
        buttonCard: "Donate via Card",
        buttonCorporate: "Corporate Sponsorship"
      },
      volunteer: {
        title: "Volunteer",
        description: "Time is as valuable as money. Join our team of dedicated volunteers.",
        items: [
          "Walk dogs and socialize cats",
          "Clean kennels and maintenance",
      ...
      storyteller: {
        title: "Help Us Tell Their Stories",
        description: "We use AI to craft compelling stories for animals in critical need. You can help by generating a campaign for a specific animal you know.",
        button: "Use Rescue Storyteller Tool"
      }
    },
    footer: {
  ...
  fa: {
    ...
    aboutPage: {
      missionTitle: "بیانیه مأموریت و ارزش‌ها",
      missionText1: "در جان‌پناه، ما بر اساس یک فلسفه اصلی عمل می‌کنیم: ما در مرحله اول درمانگر حیوانات هستیم. مأموریت اصلی ما درمان حیوانات آسیب‌دیده‌ای است که حامی دیگری ندارند.",
      missionText2: "ما به «چرخه محبت» باور داریم. مهربانی در همه وجود دارد، صرف‌نظر از پیشینه یا عقیده. نقش ما پرورش این مهربانی از طریق آموزش، الگو بودن و اقدام مستقیم است.",
      missionPoints: [
        "درمان در اولویت: مراقبت پزشکی برای مصدومان اولویت اصلی ماست.",
        "فرهنگ‌سازی: تغییر دیدگاه جامعه نسبت به حیوانات ولگرد.",
        "عقیم‌سازی به جای حذف: کنترل جمعیت به روش انسانی."
      ],
      historyTitle: "تاریخچه ما",
      historyText: "جان‌پناه که توسط منیره صفری تأسیس شد، به عنوان یک ابتکار کوچک برای کمک به حیوانات ولگرد آسیب‌دیده در تهران آغاز به کار کرد. در طول سال‌ها، به یک مرکز جامع پناهگاه و درمان تبدیل شده است که در استفاده از فناوری و مشارکت اجتماعی برای نجات زندگی‌ها پیشگام است.",
      transparencyTitle: "شفافیت مالی",
      transparencyText: "ما معتقدیم اعتماد پایه و اساس خیریه است. گزارش‌های مالی ما به طور منظم حسابرسی شده و برای بررسی موجود است. ما اطمینان می‌دهیم که هر کمک مالی مستقیماً صرف مراقبت‌های پزشکی، غذا و سرپناه حیوانات ما می‌شود."
    },
    supportPage: {
      subtitle: "مهربانی شما درهای ما را باز نگه می‌دارد. هر کمک مستقیماً یک زندگی را نجات می‌دهد.",
      donation: {
        description: "ما کاملاً به حمایت مردمی متکی هستیم. کمک‌های شما صرف موارد زیر می‌شود:",
        items: [
          "جراحی‌های اورژانسی برای قربانیان تصادف",
          "واکسیناسیون و عقیم‌سازی",
          "غذای روزانه و نگهداری پناهگاه"
        ],
        buttonCard: "کمک از طریق کارت",
        buttonCorporate: "حامی حقوقی/شرکتی"
      },
      volunteer: {
        title: "داوطلب شوید",
        description: "زمان به اندازه پول ارزشمند است. به تیم داوطلبان متعهد ما بپیوندید.",
        items: [
          "پیاده‌روی با سگ‌ها و اجتماعی‌سازی گربه‌ها",
          "نظافت لانه و نگهداری",
          "کمک در رویدادهای واگذاری",
          "حمل و نقل حیوانات به دامپزشکی"
        ],
        button: "درخواست داوطلبی"
      },
      storyteller: {
        title: "به ما کمک کنید داستان‌شان را بگوییم",
        description: "ما از هوش مصنوعی برای ساخت داستان‌های جذاب برای حیوانات نیازمند استفاده می‌کنیم. شما می‌توانید با تولید یک کمپین برای حیوانی که می‌شناسید کمک کنید.",
        button: "استفاده از ابزار داستان‌سرای نجات"
      }
    },
    footer: {
    ...
    researchPage: {
        ...
        startups: [
            ...
            },
            {
                name: "Cuddly",
                logo: "https://placehold.co/200x100/3d3d3e/ffffff?text=Cuddly", 
                description: "یک پلتفرم تأمین مالی جمع
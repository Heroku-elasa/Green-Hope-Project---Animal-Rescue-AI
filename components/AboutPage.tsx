    ...
    return (
        <div className="animate-fade-in text-white">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                ...
                <div className="max-w-4xl mx-auto space-y-12 text-lg text-gray-300 leading-relaxed">
                    <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 shadow-xl">
                        <h2 className="text-3xl font-bold text-white mb-6">Mission Statement & Values</h2>
                        <p className="mb-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 shadow-lg">
                            <h3 className="text-2xl font-bold text-pink-400 mb-4">Our History</h3>
                            <p>
                        ...
                        <div className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700 shadow-lg">
                            <h3 className="text-2xl font-bold text-teal-400 mb-4">Financial Transparency</h3>
                            <p>
